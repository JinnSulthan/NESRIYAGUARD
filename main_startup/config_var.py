...
class Config(object):
    ...
    ASSISTANT_START_PIC = os.environ.get(
        "ASSISTANT_START_PIC", "https://telegra.ph//file/9dd271d3a066b459d4cde.jpg"
    )
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/MR-JINN-OF-TG/NESRIYA-GUARD"
    )
    ALIVE_IMG = os.environ.get(
        "ALIVE_IMG", "https://telegra.ph//file/9dd271d3a066b459d4cde.jpg"
    )
    U_BRANCH = "master"
