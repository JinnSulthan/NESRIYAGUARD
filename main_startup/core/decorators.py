        ...
        async def wrapper(client, message):
            ...
            if ignore_errors:
                ...
                try:
                    ...
                    text += "\n\n__You can Forward This to @MR_JINN_OF_TG, If You Think This is Serious A Error!__"
                    try:
    ...
    def decorator(func):
        async def wrapper(client, message):
            try:
                ...
                text += "\n\n__You can Forward This to @MR_JINN_OF_TG, If You Think This is A Error!__"
                try:
                    await client.send_message(Config.LOG_GRP, text)
                except BaseException:
                    logging.error(text)
